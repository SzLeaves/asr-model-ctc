...
def model_bigru(
    ...
    # 全连接层整合
    dense_3 = Dense(n_cells, activation="relu")(gru_all_1)
...
# 保存模型
bigru_model.save(FILES_PATH + "models/dense/bigru-x2.h5")
# 保存训练数据
with open(FILES_PATH + "models/dense/bigru-x2-h.pkl", "wb") as file:
