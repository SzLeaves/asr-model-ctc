...
def model_bigru(
    ...
    # 一维卷积层
    conv_1 = Conv1D(
        filters=n_mfcc, kernel_size=4, strides=1, padding="same", activation=None
    )(input_data)
...
# 保存模型
bigru_model.save(FILES_PATH + "models/conv/bigru-conv-x6.h5")
# 保存训练数据
with open(FILES_PATH + "models/conv/bigru-conv-x6-h.pkl", "wb") as file:
